...
export const environment = {
  cognito: {
    cognitoUserPoolId: 'ap-south-1_aaPSwPS14', // Replace with your actual User Pool ID
    cognitoClientId: '42pb85v3sv84jdrfi1rub7a4e5',       // Optional: Add your Client ID if needed
  },
  production: true,
  appVersion: 'v8.2.4',
