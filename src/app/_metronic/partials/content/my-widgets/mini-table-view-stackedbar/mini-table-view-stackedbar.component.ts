...
@Component({
  selector: 'app-mini-table-view-stackedbar',

  templateUrl: './mini-table-view-stackedbar.component.html',
  styleUrl: './mini-table-view-stackedbar.component.scss'
})




export class MiniTableViewStackedbarComponent {
  modalRef: NgbModalRef | undefined;
          @Input() modal :any
         // Accept row data
         
          @Output() modalClose = new EventEmitter<void>(); // Emit an event when the modal is closed
          @Input() minitableDataStacked: any[] = [];
          @Input() emitEvent: any[] = [];
    ...
    storeFormLabel: any;
        ...
        console.log('miniTableData checking from stackedbar chart',this.minitableDataStacked)
        ...
        this.processEvent(this.minitableDataStacked);
