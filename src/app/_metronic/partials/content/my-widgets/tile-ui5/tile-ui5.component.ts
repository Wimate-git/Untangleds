...
@Component({
  selector: 'app-tile-ui5',

  templateUrl: './tile-ui5.component.html',
  styleUrl: './tile-ui5.component.scss'
})
export class TileUi5Component {
  @Input() item:any
  @Input() index:any
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    console.log("tile data check from tile5 ",this.item)
