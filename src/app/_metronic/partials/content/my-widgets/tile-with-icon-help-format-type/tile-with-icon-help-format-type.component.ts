...
@Component({
  selector: 'app-tile-with-icon-help-format-type',

  templateUrl: './tile-with-icon-help-format-type.component.html',
  styleUrl: './tile-with-icon-help-format-type.component.scss'
})
export class TileWithIconHelpFormatTypeComponent {
