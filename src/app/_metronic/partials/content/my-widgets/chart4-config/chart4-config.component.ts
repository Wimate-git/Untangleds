...
@Component({
  ...
  templateUrl: './chart4-config.component.html',
  styleUrl: './chart4-config.component.scss'
})
export class Chart4ConfigComponent implements OnInit{
...
openChartModal4(tile: any, index: number) {
