...
@Component({
  selector: 'app-tile1-help-primary-value',

  templateUrl: './tile1-help-primary-value.component.html',
  styleUrl: './tile1-help-primary-value.component.scss'
})
export class Tile1HelpPrimaryValueComponent {
