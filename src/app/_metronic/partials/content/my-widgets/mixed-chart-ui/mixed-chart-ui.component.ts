...
@Component({
  selector: 'app-mixed-chart-ui',

  templateUrl: './mixed-chart-ui.component.html',
  styleUrl: './mixed-chart-ui.component.scss'
})
export class MixedChartUiComponent {
  chartOptions: any;
  gridOptions: any;
...
data.forEach((packet: any,matchedIndex:number) => {
  ...
  if(packet.grid_type == 'mixedChart'&& this.index==matchedIndex && packet.id === this.item.id){
