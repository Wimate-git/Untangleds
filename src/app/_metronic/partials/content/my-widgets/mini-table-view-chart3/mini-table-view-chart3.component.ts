...
@Component({
  selector: 'app-mini-table-view-chart3',
  // standalone: true,
  // imports: [],
  templateUrl: './mini-table-view-chart3.component.html',
  styleUrl: './mini-table-view-chart3.component.scss'
})
export class MiniTableViewChart3Component {
   modalRef: NgbModalRef | undefined;
      ...
      async processEvent(event:any) {
        ...
        console.log('this.dynamicTableValues checking from miniChart1', this.dynamicTableValues);
        ...
        if (matchingTables.length > 0) {
            ...
            for (let matchedTableData of matchingTables) {
                ...
                console.log('columnDefs checking from chart3 mini',columnDefs)
      
                this.columnDefsMap[tableId] = columnDefs;
                console.log('this.columnDefsMap[tableId] chgeck from chart1',this.columnDefsMap[tableId])
