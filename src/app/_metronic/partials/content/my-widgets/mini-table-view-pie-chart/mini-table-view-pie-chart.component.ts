...
@Component({
  selector: 'app-mini-table-view-pie-chart',

  templateUrl: './mini-table-view-pie-chart.component.html',
  styleUrl: './mini-table-view-pie-chart.component.scss'
})
export class MiniTableViewPieChartComponent {
   modalRef: NgbModalRef | undefined;
    ...
    storeFormLabel: any;
      ...
      console.log('miniTableData checking from piechart',this.minitableDataChart1)
