...
const storeAllRowData = this.responseRowData
...
this.formattedRowData = await this.formatDateFields(storeAllRowData,matchedDateFields);
console.log('Formatted Data:', storeAllRowData);



this.emitfullRowDataToParent.emit(storeAllRowData)
