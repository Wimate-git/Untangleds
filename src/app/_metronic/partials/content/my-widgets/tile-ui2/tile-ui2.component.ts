...
@Component({
  selector: 'app-tile-ui2',

  templateUrl: './tile-ui2.component.html',
  styleUrl: './tile-ui2.component.scss'
})
export class TileUi2Component {
  @Input() item:any
  @Input() index:any
  ...
  @Input() tile2Width:any
  @Input() tile2Height:any
