...
@Component({
  selector: 'app-data-table-funnel-chart',

  templateUrl: './data-table-funnel-chart.component.html',
  styleUrl: './data-table-funnel-chart.component.scss'
})
export class DataTableFunnelChartComponent {
