...
@Component({
  ...
  templateUrl: './pie-chart-ui.component.html',
  styleUrl: './pie-chart-ui.component.scss'
})
export class PieChartUiComponent implements OnChanges,OnInit{
  chartOptions: any;
  gridOptions: any;
  ...
  ngOnInit(){
    ...
    this.summaryService.lookUpData$.subscribe((data: any) => {
      ...
      dataArray.forEach((packet: any, matchedIndex: number) => {
        ...
        if (packet.grid_type == 'Piechart' && packet.id === this.item.id) {
...
console.log('this.gridOptions checking from chart',this.gridOptions)
 ...
 if (selectType === 'NewTab') {
  ...
  if(this.isEditModeView==true){
    ...
    console.log('pointData checking pie chart', pointData);
