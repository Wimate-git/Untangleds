...
@Component({
  selector: 'app-mini-table-view-funnel-chart',

  templateUrl: './mini-table-view-funnel-chart.component.html',
  styleUrl: './mini-table-view-funnel-chart.component.scss'
})
export class MiniTableViewFunnelChartComponent {
modalRef: NgbModalRef | undefined;
          @Input() modal :any
         // Accept row data
         
          @Output() modalClose = new EventEmitter<void>(); // Emit an event when the modal is closed
          @Input() minitableDataFunnelChart: any[] = [];
    ...
    storeFormLabel: any;
        ...
        console.log('miniTableData checking from stackedbar chart',this.minitableDataFunnelChart)
        ...
        this.processEvent(this.minitableDataFunnelChart);
