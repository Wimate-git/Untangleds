...
@Component({
  ...
  templateUrl: './pie-chart-config.component.html',
  styleUrl: './pie-chart-config.component.scss'
})
export class PieChartConfigComponent {
...
openPieChartModal(tile: any, index: number) {
