...
@Component({
  selector: 'app-mini-table-view-chart1',

  templateUrl: './mini-table-view-chart1.component.html',
  styleUrl: './mini-table-view-chart1.component.scss'
})
export class MiniTableViewChart1Component {
    ...
    async processEvent(event:any) {
      ...
      if (matchingTables.length > 0) {
          ...
          for (let matchedTableData of matchingTables) {
              ...
              console.log('columnDefs checking from chart mini',columnDefs)
