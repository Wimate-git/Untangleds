...
@Component({
  selector: 'app-chart1-help-format-type',

  templateUrl: './chart1-help-format-type.component.html',
  styleUrl: './chart1-help-format-type.component.scss'
})
export class Chart1HelpFormatTypeComponent {
